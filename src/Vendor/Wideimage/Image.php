...
use GdImage;
use WideImage\Exception\{GDFunctionResultException, UnknownErrorWhileMappingException};
...
abstract class Image
{
     ...
     */
    public function saveToFile($uri): void
    {
     ...
     */
    public function output($format): void
    {
        $args = func_get_args();
     ...
     * @param array $color
     */
    public function setRGBAt($x, $y, $color): void
    {
     ...
     */
    public function copyTransparencyFrom($sourceImage, $fill = true): void
    {
     ...
     * </code>
     *
     * @param Image $overlay The overlay image
     ...
     * @return Image The resulting image with resized canvas
     */
     ...
     * @return Image The resulting image with round corners
     */
     ...
     *
     * @param Image $mask The mask image, greyscale
     ...
     *
     * @return Image negative of the image
     */
     ...
     * @return Image Unsharpened copy of the image
     **/
     ...
     * @return Image Image with corrected gamma
     **/
     ...
     * @return Image Image with noise added
     **/
     ...
     * @param int $top
     **/
    public function copyTo($dest, $left = 0, $top = 0): void
    {
     ...
     * @param $data Data
     */
    protected function writeHeader($name, $data): void
    {
        header($name . ': ' . $data);
    }
