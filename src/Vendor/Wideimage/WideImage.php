...
use GdImage;
use WideImage\Exception\{Exception, InvalidImageHandleException, InvalidImageSourceException, UnsupportedFormatException};
...
class WideImage
{
    public const SIDE_TOP_LEFT = 1;
    public const SIDE_TOP = 2;
    public const SIDE_TOP_RIGHT = 4;
    public const SIDE_RIGHT = 8;
    public const SIDE_BOTTOM_RIGHT = 16;
    public const SIDE_BOTTOM = 32;
    public const SIDE_BOTTOM_LEFT = 64;
    public const SIDE_LEFT = 128;
    public const SIDE_ALL = 255;
     ...
     */
    public static function registerCustomMapper($mapper_class_name, $mime_type, $extension): void
    {
     ...
     * </code>
     */
    public static function unregisterCustomMapper($mapper_class_name, $mime_type): void
    {
     ...
     * @return Image|PaletteImage|TrueColorImage
     */
    public static function load($source)
    {
        ...
        return call_user_func([__CLASS__, 'loadFrom' . $predictedSourceType], $source);
    }
    ...
    public static function loadFromFile($uri)
    {
        ...
        if (!static::isValidImageHandle($handle)) {
            ...
            if (!static::isValidImageHandle($handle)) {
                $mimeTypes = array_keys(MapperFactory::getCustomMappers());

                foreach ($mimeTypes as $mimeType) {
                    $mapper = MapperFactory::selectMapper(null, $mimeType);
     ...
     * @param mixed $handle The variable to check
     */
    public static function assertValidImageHandle($handle): void
    {
        if (!static::isValidImageHandle($handle)) {
